...
with DAG(
    dag_id='spm.fullload.item_technical_property',
    ...
    progress_source = ProgressSourceConnector(
        conn_id='gdm',
        database='gdm',
        sql='SELECT * FROM PUB."item_technical_property"',
        query_mode='default'
    )
