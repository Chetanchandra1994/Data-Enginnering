...
,DATA:"project_event_trans_type_code" AS PROJECT_EVENT_TRANS_TYPE_CODE
,DATA:"project_event_trans_type_name_id" AS PROJECT_EVENT_TRANS_TYPE_NAME_ID
...
,{{ dbt_utils.generate_surrogate_key(['DATA:"project_event_trans_type_uuid"']) }} as TABLE_SK
...
from {{ source("landing_spm_gdm", "PROJECT_EVENT_TRANS_TYPE") }}
