...
SELECT
DATA:"salesman_uuid" AS SALESMAN_UUID
,DATA:"slsmn_code" AS SLSMN_CODE
,DATA:"slsmn_name" AS SLSMN_NAME
...
,{{ dbt_utils.generate_surrogate_key(['DATA:"salesman_uuid"']) }} as TABLE_SK
...
from {{ source("landing_spm_gdm", "SALESMAN") }}
